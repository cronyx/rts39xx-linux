...
static u8 create_instance_adv_data(struct hci_dev *hdev, u8 instance, u8 *ptr)
{
	...
	/* some smart phones, like XiaoMi4, connect to BREDR only
	 * even if we set bluetooth to dual mode. We broadcast that
	 * we do not support BREDR in BLE broadcast data so that
	 * we can choose to connect to BLE or BREDR.
	 */
