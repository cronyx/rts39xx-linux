...
static struct clocksource clocksource_mips_spare = {
	.name		= "MIPS SPARE",
	.read		= c0_hpt_read,
	.mask		= CLOCKSOURCE_MASK(32),
	.flags		= CLOCK_SOURCE_IS_CONTINUOUS,
...
int __init init_r4k_clocksource(void)
{
	...
	clocksource_mips_spare.rating = 100 + mips_hpt_frequency / 10000000;
	clocksource_register_hz(&clocksource_mips_spare, mips_hpt_frequency);
