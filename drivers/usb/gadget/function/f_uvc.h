...
void uvc_copy_stream_descs(u8 **mem,
				  struct usb_descriptor_header ***dst);
int uvc_get_stream_descs_num(void);
int uvc_get_stream_descs_len(void);
void uvc_copy_h264_descs(u8 **mem, struct usb_descriptor_header ***dst);
int uvc_get_h264_descs_num(void);
int uvc_get_h264_descs_len(void);
int getstsepactive(int epnum);
int dwc_otg_pcd_wait_clearfeature(int epnum);
