...
static const char * const rlx_names_jpeg_div[] = {
	"usb_pll_2", "usb_pll_3", "sys_pll1_5",
};
...
static const char * const rlx_names_dram_div[] = {
	"usb_pll_2", "sys_pll0_3", "sys_pll1_5", "sys_pll1_2"
};
...
static const char * const rlx_names_isp_div[] = {
	"usb_pll_5", "usb_pll_3", "sys_pll1_5"
};
...
static const char * const rlx_names_mipi_div[] = {
	"usb_pll_2", "usb_pll_3", "sys_pll1_2"
};
...
static const char * const rlx_names_i2c_div[] = {
	"usb_pll_3", "sys_pll0_5", "sys_pll1_3"
};

static const char * const rlx_names_xb2_div[] = {
	"usb_pll_2", "sys_pll0_3", "sys_pll1_2"
};

static const char * const rlx_names_uart_div[] = {
	"usb_pll_5", "sys_pll0_3", "sys_pll1_5"
};
...
static const char * const rlx_names_i2s_div[] = {
	"usb_pll_5", "usb_pll_3", "sys_pll1_2", "sys_pll2_2",
};
...
static const char *rlx_names_h265_bclk_div[] = {
	"usb_pll_2", "sys_pll0_7", "sys_pll0_3", "sys_pll1_7"
};
		...
		unsigned long parent_rate)
{
	...
	case 400000000:
		...
		clk_set_rate(clk1, 450000000);
		clk_set_rate(clk2, 400781250);
		break;
	case 300000000:
	...
	case 225000000:
		...
		clk_set_rate(clk1, 225000000);
		clk_set_rate(clk2, 225000000);
		break;
	case 200000000:
		clk0 = clk_get(NULL, "sys_pll0_2");
		if (IS_ERR(clk0))
		...
		unsigned long parent_rate)
{
	...
	case 50000000:
		...
		clk_set_rate(clk1, 5000000);
		clk_set_rate(clk2, 5000000);
		break;
	case 60000000:
		clk0 = clk_get(NULL, "usb_pll_2");
		if (IS_ERR(clk0))
		...
		unsigned long parent_rate)
{
	...
	case 150000000:
		...
		clk_set_rate(clk1, 150000000);
		clk_set_rate(clk2, 150000000);
		break;
	case 142857142:
		clk0 = clk_get(NULL, "sys_pll1_7");
		if (IS_ERR(clk0))
			return PTR_ERR(clk0);

		clk_set_parent(clk1, clk0);

		clk_set_rate(clk1, 142857142);
		clk_set_rate(clk2, 142857142);
		break;
	case 128571428:
		clk0 = clk_get(NULL, "sys_pll0_7");
		if (IS_ERR(clk0))
			return PTR_ERR(clk0);

		clk_set_parent(clk1, clk0);

		clk_set_rate(clk1, 128571428);
		clk_set_rate(clk2, 128571428);
		break;
	default:
		pr_debug("%s %ld not supported yet\n",
			clk_hw_get_name(hw), rate);
...
static void rlx_clocks_init(struct device_node *node)
{
	...
	clk_set_rate(pll0_clk, 900000000);
...
CLK_OF_DECLARE(rts3913_clocks, "realtek,rts3913-clocks", rlx_clk_init);
