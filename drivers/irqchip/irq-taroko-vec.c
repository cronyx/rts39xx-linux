...
int __init mips_vec_irq_of_init(struct device_node *of_node, struct device_node *parent)
{
	__mips_vec_irq_init(of_node);
	return 0;
}
IRQCHIP_DECLARE(vec_intc, "realtek,vec-interrupt-controller", mips_vec_irq_of_init);
